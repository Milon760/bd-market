...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <div className={` ${mode ? 'bg-slate-600 text-white' : 'bg-white'} p-8 mx-5 mb-10 shadow shadow-black rounded`}>
        ...
        <div className='md:flex justify-around  my-16 text-center'>
          <div className='mt-5'>
            <h1 className='text-2xl font-medium mb-5 flex items-center justify-center gap-4'> <MdEmail /> Email Us </h1>
          ...
          <div className='mt-5'>
            <h1 className='text-2xl font-medium mb-5 flex items-center justify-center gap-4'> <FaPhone /> Call Us </h1>
            <span className='text-center'> +880 1782-671468 (Mon-Fri, 9 AM - 5 PM BDT) </span>
          </div>
          <div className='mt-5'>
            <h1 className='text-2xl font-medium mb-5 flex items-center justify-center gap-4'><IoLocationSharp /> Visit Us </h1>
            <span className='text-center'>  Laxmipu, Sadullapur, Gaibandha, <br /> Bangladesh </span>
          </div>
        </div>

        <div className={` ${mode ? 'bg-slate-700' : 'bg-[#f8f8f8]'} max-w-[40rem] p-10 my-6 mx-auto rounded`}>
          ...
          <form onSubmit={submitForm}>
            ...
            <button type='submit' className='w-full bg-blue-600 py-1.5 mt-8 rounded text-xl text-white'> Send Message </button>
          </form>
        </div>
